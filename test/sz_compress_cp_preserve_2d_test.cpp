...
int main(int argc, char ** argv){
    ...
    // unsigned char * result =  sz_compress_cp_preserve_2d_online(U, V, r1, r2, result_size);
    unsigned char * result =  sz_compress_cp_preserve_2d_online_log(U, V, r1, r2, result_size);
